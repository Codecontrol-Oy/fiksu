    ...
    <div>
      ...
      <RadialChart
        ...
        <div style={{
          ...
          <span style={{ color: 'rgb(39, 140, 180)', fontSize: '72px' }}>{props.data.length > 1 ? props.data.reduce((a, b) => typeof(a) == 'object' ? a.angle + b.angle : a + b.angle).toFixed(1) : props.data[0].angle}</span>
        </div>
      </RadialChart>
    </div>
  )
