            ...
            <GridContainer size={12} align={"center"}>
                <GridRow>
                    ...
                    <Block style={{ textAlign: 'center'}}>
                        {householdData && householdData.getTopFamilyResults && householdData.getTopFamilyResults.length > 0 && householdData.getTopFamilyResults.map(household => (household.position < 4) && <Grid sizeS={12} sizeM={6} sizeL={3}>
                            <Block>
