...
mutation createPasswordReset($nickname: String!) {
    createPasswordReset(nickname: $nickname)
}
`

const MUTATION_CONFIRM_NEW_PASSWORD = gql`
mutation confirmPasswordReset($nickname: String!, $verificationToken: String!, $newPassword: String!) {
