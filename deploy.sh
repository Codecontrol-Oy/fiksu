...
ssh $SERVER_USERNAME@jankon.energy "sudo docker pull codecontrol/fiksu-frontend:dev-$TRAVIS_BUILD_NUMBER'"
ssh $SERVER_USERNAME@jankon.energy "sudo docker pull fixu/backend:dev-$TRAVIS_BUILD_NUMBER'"
