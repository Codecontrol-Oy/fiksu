...
exports.seed = () => {
    ...
    addEcoAction('En mennyt tänäänkään töihin/kouluun helikopterilla', 'Käyttämällä esimerkiksi pyörää, säästät luontoa ja kuntosi kohenee.', 0.2, true, 'Hyötyliikunta mestari', 'Olet erinomaisesti nostanut hyötyliikunnan määrää arjessasi.', 'icofont-helicopter')
