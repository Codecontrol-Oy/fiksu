...
exports.seed = () => {
    ...
    addEcoAction('Käytin kestokassia', 'Käyttämällä kestokassia muovikassin sijaan, vähennät muovijätteen määrää.', 0.2, true, 'Kestokassi', 'Käytät omaa kestokassia kun käyt esimerkiksi kaupassa.', 'icofont-bag')
    addEcoAction('Vähensin autoilua', 'Autoilu kuormittaa ympäristöä. Vähentämällä autoilua säästät ympäristöä ja parhaassa tapauksessa parannat myös omaa kuntoasi.', 0.2, true, 'Polkuauto', 'Olet jättänyt auton talliin ja kulkenut esimerkiksi pyörällä.', 'icofont-car-alt-2')
    ...
    addEcoAction('En mennyt tänäänkään töihin/kouluun helikopterilla', 'Käyttämällä esimerkiksi pyörällä, säästät luontoa ja kuntosi kohenee.', 0.2, true, 'Hyötyliikunta mestari', 'Olet erinomaisesti nostanut hyötyliikunnan määrää arjessasi.', 'icofont-helicopter')
    addEcoAction('Putsasin jääkaapin', 'Pitämällä jääkaapin puhtaana säästät energiaa.', 0.2, true, 'Putipuhdas', 'Pidät jääkaapin puhtaana ansiokkaasti.', 'icofont-bucket1')
    addEcoAction('Käytin kirjaston valikoimaa', 'Kirjojen lainaaminen on ekoteko siinä missä kaiken muunkin tavaran kierrättäminen. Kirjoja ei tarvitse tuottaa niin paljoa, kun niitä lainataan ja kaikilla ei ole omaa kopiota.', 0.2, true, 'Lukutoukka', 'Lainaat kirjoja niiden ostamisen sijasta.', 'icofont-read-book')
    addEcoAction('Pystytin linnunpöntön', 'Linnut auttavat sinua pihasi tuholaistorjunnassa. Esimerkiksi tiaiset syövät paarmoja ja hyttysiä.', 0.2, true, 'Linnunpönttö', 'Olet pystyttänyt linnunpönttöjä ansiokkaasti.', 'icofont-bird')
    addEcoAction('Tarjosin ötököille pesintä- tai suojapaikan pihallani', 'Tarjoamalla pesintäpaikkoja pölyttäjille, he varmistavat, että saat suuren hedelmä- ja marjasadon.', 0.2, true, 'Ötökkä', 'Olet tarjonnut ötököille pesintäpaikkoja.', 'icofont-bug')
    addEcoAction('Ostin lähiruokaa', 'Lähiruoka tulee pieniltä toimittajilta, joiden tuotanto on monipuolista. Näin tuotettuna ympäristövaikutukset ovat vähäisemmät kuin yksipuolisen viljelyn. Lähiruoka tuotetaan lähellä, joten sen toimitusketju on lyhyt.', 0.2, true, 'Lähiruoka', 'Tuet pieniä toimittajia ostamalla lähiruokaa.', 'icofont-food-basket')
